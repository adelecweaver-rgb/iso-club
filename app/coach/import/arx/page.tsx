...
import { CoachArxImportTool } from "@/components/coach-arx-import-tool";
...
export default async function CoachArxImportPage() {
  ...
  return <CoachArxImportTool initialMembers={members} />;
}
